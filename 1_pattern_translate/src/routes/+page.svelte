<script>
	...
	// import Pattern from '$lib/components/3_PatternParalellogramm.svelte';
	// import Pattern from '$lib/components/4_PatternParalellogramme2.svelte';
	// import Pattern from '$lib/components/4_PatternParalellogramme2b.svelte';
